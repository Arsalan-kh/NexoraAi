...
export async function createSampleResume(userId: string) {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: {
        categories: [
          { id: crypto.randomUUID(), name: 'Frontend Frameworks', skills: ['React', 'Next.js', 'Vue 3', 'TypeScript'] },
          { id: crypto.randomUUID(), name: 'Engineering Tools', skills: ['Webpack', 'Vite', 'Turborepo', 'CI/CD'] },
          { id: crypto.randomUUID(), name: 'Other Technologies', skills: ['Node.js', 'Docker', 'PostgreSQL', 'Figma'] },
        ],
      },
    },
    {
